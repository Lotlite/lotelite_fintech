      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Property Loan</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Loan Against Property</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Education Loan</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-400">
                <span className="block">123 Finance Street</span>
              ...
              <li>
                <a href="mailto:info@fintech.com" className="text-gray-400 hover:text-white transition-colors">
                  info@fintech.com
                </a>
              </li>
            </ul>
